...
class Transposition(single_pred_dataset.DataLoader):
    
    """Data loader class to load datasets in Transposition Prediction task. More info: https://tdcommons.ai/single_pred_tasks/epitope/
    ...
    def __init__(self, name, path='./data', label_name=None, print_stats=False, convert_format=None):
        ...
        super().__init__(name, path, label_name, print_stats,
                         dataset_names=dataset_names["Transposition"], convert_format = convert_format)
        self.entity1_name = 'Protein'
