from .loss_base import CrossEntropy, MSE
...
from .loss_impl.focal_R import FocalR
from .loss_impl.balanced_mse_loss import BalancedMSELoss
from .loss_impl.LDS import LDS
...
__all__ = [
    ...
    'MSE', 'FocalR', 'BalancedMSELoss', 'LDS'
]